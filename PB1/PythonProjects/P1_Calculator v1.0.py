...
button_subtract = Button(root, text = "-", padx = p2x + 1, pady = p2y, command = lambda: button_click())    #SUB
button_multiply = Button(root, text = "x", padx = p2x, pady = p2y, command = lambda: button_click())        #MUL
button_divide = Button(root, text = "/", padx = p2x + 1, pady = p2y, command = lambda: button_click())      #DIV
button_equals = Button(root, text = "=", padx = p2x - 1, pady = p2y, command = button_equal)                #EQL (Only Add)

button_clear = Button(root, text = "C", padx = p2x -1, pady = p2y, command = button_clear)                  #CLR OK
