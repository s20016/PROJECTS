...
public class KnapsackGA {
  public static final int KNAP_MAX = 6;		// ナップサックの耐重量
  public static final int ITEM_NUM = 5;		// 品物の種類

  public static final int IND_NUM = 8;		// 個体の数
  public static final double MUTATE_RATE = 0.1;	// 突然変異する確率（10％）

  public static char[] itemName = { 'A', 'B', 'C', 'D', 'E' };	// 品物の名称
  public static int[] itemWeight = { 1, 2, 3, 4, 5 };		// 品物の重量
  public static int[] itemValue = { 100, 300, 350, 500, 650 };	// 品物の価値

  public static int indGeneration;				// 個体の世代
  public static int[][] indGene = new int[IND_NUM][ITEM_NUM];	// 個体の遺伝子
  public static int[] indWeight = new int[IND_NUM];		// 個体の重量
  public static int[] indValue = new int[IND_NUM];		// 個体の価値
  public static int[] indFitness = new int[IND_NUM];		// 個体の適応度
